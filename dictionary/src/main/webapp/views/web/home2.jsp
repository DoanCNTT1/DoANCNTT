...
<input maxlength="49" type="text" class="input_box" autocomplete="off" value="" id="txtSearchBox" name="termEn">
...
<option value="${pageContext.request.contextPath}/trang-chu?searchOptions=1" >Anh - Việt</option>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#txtSearchBox').autocomplete({
			source: '${pageContext.request.contextPath}/search2'
		});
	});
</script>

...
Word Insert:<input maxlength="49" type="text" class="input_box" id="txtSearchBox" placeholder="Nhập từ mới vào" value="${word}" id="txtSearchBox" name="WordAdd">
<c:out value="${checkError.getErrorWord()}"/>
Pronunciation Insert:<input maxlength="49" type="text" class="input_box"  value="${pronunciation}" placeholder="Nhập vào cách phát âm"  name="Pronunciation">
<c:out value="${checkError.getErrorPro()}"/>
Word Type Insert:<input maxlength="49" type="text" class="input_box" value="${wordtype}" placeholder="Nhập vào loại từ "  name="WordType">
<c:out value="${checkError.getErroWordType()}"/>
Mean Insert:<input maxlength="49" type="text" class="input_box" value="${mean}" placeholder="Nhập vào nghĩa của từ"  name="Mean">
...
<option value="${pageContext.request.contextPath}/web/AddNewWord.jsp" >Anh-Việt</option>
</select>
